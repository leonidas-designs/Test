...
import sty from "./PlasmicStatistic.module.css"; // plasmic-import: wiWxgibpud5U/css
...
function PlasmicStatistic__RenderFunc(props: {
  ...
  return (
    ...
    >
      {renderPlasmicSlot({
        defaultContents: (
          <div className={classNames(projectcss.all, sty.freeBox__mzjDl)}>
            <p
              className={classNames(
                projectcss.all,
                projectcss.p,
            ...
            <PlasmicImg__
              alt={""}
              className={classNames(sty.img__qDcY2, {
                [sty.imghideIcon__qDcY28Gx7C]: hasVariant(
                  $state,
                  "hideIcon",
                  "hideIcon"
                )
      ...
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__b1CYa)}
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__e2L50, {
            [sty.freeBoxhideIcon__e2L508Gx7C]: hasVariant(
              $state,
              "hideIcon",
              "hideIcon"
            )
        ...
        <div className={classNames(projectcss.all, sty.freeBox__mi5VV)}>
          <Stack__
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.freeBox__nFfs2, {
              [sty.freeBoxhideTrendTracker__nFfs2MJwyq]: hasVariant(
                $state,
                "hideTrendTracker",
                "hideTrendTracker"
              )
          ...
          >
            <div
              className={classNames(projectcss.all, sty.freeBox__xtZN, {
                [sty.freeBoxhideTrendTracker__xtZNmJwyq]: hasVariant(
                  $state,
                  "hideTrendTracker",
                  "hideTrendTracker"
                )
            ...
            >
              <div className={classNames(projectcss.all, sty.freeBox__phKz)}>
                {renderPlasmicSlot({
            ...
            <div className={classNames(projectcss.all, sty.freeBox___9T28G)}>
              <div className={classNames(projectcss.all, sty.freeBox__rx40Y)}>
                {renderPlasmicSlot({
