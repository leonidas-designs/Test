...
import sty from "./PlasmicProduct.module.css"; // plasmic-import: XP53Hqu2wXsO/css
  ...
  const new$Queries: Record<string, ReturnType<typeof usePlasmicDataOp>> = {
    revenueByDateRange: usePlasmicDataOp(() => {
      return {
        ...
        opId: "80b67c10-f98e-411f-a1af-c5d37db00cae",
        userArgs: {
          query: [$state.start.value, $state.end.value]
        },
        cacheKey: `plasmic.$.80b67c10-f98e-411f-a1af-c5d37db00cae.$.`,
    ...
    topProductsByQuantityLastYear: usePlasmicDataOp(() => {
      return {
        sourceId: "kKH6mXrGmFfHeifKtJbVxS",
        opId: "9c4ff06b-b284-4fc2-a80b-627ecd1dbace",
        userArgs: {
          query: [$state.start.value, $state.end.value]
        },
        cacheKey: `plasmic.$.9c4ff06b-b284-4fc2-a80b-627ecd1dbace.$.`,
        invalidatedKeys: null,
        roleId: null
      };
    }),
    totalProductCountByDateRange: usePlasmicDataOp(() => {
      return {
        sourceId: "kKH6mXrGmFfHeifKtJbVxS",
        opId: "5f5a3bc9-8c41-4c08-a73f-bada1a492b72",
        userArgs: {
          query: [$state.start.value, $state.end.value]
        },
        cacheKey: `plasmic.$.5f5a3bc9-8c41-4c08-a73f-bada1a492b72.$.`,
        invalidatedKeys: null,
        roleId: null
      };
    }),
    unitsSoldByDateRange: usePlasmicDataOp(() => {
      return {
        sourceId: "kKH6mXrGmFfHeifKtJbVxS",
        opId: "03e57862-979c-42be-9acf-32be9751689d",
        userArgs: {
          query: [$state.start.value, $state.end.value]
        },
        cacheKey: `plasmic.$.03e57862-979c-42be-9acf-32be9751689d.$.`,
        invalidatedKeys: null,
        roleId: null
      };
    }),
    listAllProductNames: usePlasmicDataOp(() => {
      return {
        sourceId: "kKH6mXrGmFfHeifKtJbVxS",
        opId: "8506ab0b-1d9d-43f3-9051-96fbc67fd360",
        userArgs: {},
        cacheKey: `plasmic.$.8506ab0b-1d9d-43f3-9051-96fbc67fd360.$.`,
        invalidatedKeys: null,
        roleId: null
      };
    })
            ...
            <DataCtxReader__>
              {$ctx => (
                <React.Fragment>
                  ...
                  <section
                    className={classNames(projectcss.all, sty.section__xWqoC)}
                  >
                    <DateTimeRangePicker
                    ...
                    <Stack__
                      as={"div"}
                      hasGap={true}
                      className={classNames(projectcss.all, sty.freeBox__nx6N)}
                    >
                      <Statistic
                        className={classNames(
                          "__wab_instance",
                        ...
                        unit={
                          ...
                          >
                            ...
                            <PlasmicImg__
                              alt={""}
                              className={classNames(sty.img__hqKH)}
                              displayHeight={"auto"}
                      ...
                      <Statistic
                        ...
                        unit={
                          ...
                          >
                            ...
                            <PlasmicImg__
                              alt={""}
                              className={classNames(sty.img___8HXkK)}
                              displayHeight={"auto"}
                              displayMaxHeight={"28px"}
                              displayMaxWidth={"28px"}
                              displayMinHeight={"0"}
                      ...
                      <Statistic
                        ...
                        unit={
                          ...
                          >
                            ...
                            <PlasmicImg__
                              alt={""}
                              className={classNames(sty.img__uBkWc)}
                              displayHeight={"auto"}
                              displayMaxHeight={"28px"}
                              displayMaxWidth={"28px"}
                              displayMinHeight={"0"}
                  ...
                  <section
                    className={classNames(projectcss.all, sty.section__dhx9H)}
                  >
                    <div
                      className={classNames(projectcss.all, sty.freeBox__l52Zp)}
                    >
                      <h2
                        className={classNames(
                          projectcss.all,
